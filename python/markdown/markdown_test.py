...
class MarkdownTest(unittest.TestCase):
    ...
    def test_custom(
        ...
        self.assertEqual(
            parse("This is a test with _italic_ and __bold__ and more _italic_ and __bold__."),
            "<p>This is a test with <em>italic</em> and <strong>bold</strong> and more <em>italic</em> and <strong>bold</strong>.</p>",
        )
